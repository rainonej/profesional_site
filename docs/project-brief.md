# Project Brief — Agreni Batra Personal Site

## What this is

A demo personal academic website for **Agreni Batra**, built to evaluate whether a static site can credibly support three simultaneous goals without committing to paid site builders or locking in a permanent tone.
...
All three are framed as replaceable placeholders reflecting publicly available context:

1. **Equitable STEM learning environments** — informed by youth-facing STEM programming and curriculum design (current NYC context)
...
A neutral "hybrid" voice supports all three audiences from the same content architecture. The site does not need to commit to "academic-first" vs "consulting-first" at the demo stage.
...
- [ ] Blog cadence: occasional or regular
